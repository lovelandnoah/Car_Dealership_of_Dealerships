...
ActiveRecord::Schema.define(version: 20160111191347) do
  ...
  add_index "cars", ["salesman_id"], name: "index_cars_on_salesman_id", using: :btree
  ...
  add_foreign_key "cars", "salesmen"
  add_foreign_key "customers", "salesmen"
